...
def preprocess_data(df, data_source, split, augtime):
    ...
    if split == "train":
        ...
        e_smiles_list = process_map(
            get_e_smiles, tqdm(df["reactants>reagents>production"], desc="transforming into ReactSeq ..."), max_workers=20
        )
...
def main():
    ...
    parser.add_argument(
        ...
        default=False,
        choices=[False, True],
        help="Unkown reaction type (False) or Given reaction type (True)",
    )
